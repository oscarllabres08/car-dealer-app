        ...
        <div className="mb-4 sm:mb-6 md:mb-8 animate-fade-in-down">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-3 sm:gap-4">
            ...
            <div className="w-full lg:w-auto">
              <div className="flex w-full lg:w-auto rounded-xl bg-slate-800/80 border border-slate-700 p-1 backdrop-blur-sm">
                <button
                  type="button"
                  onClick={() => setActiveView('inventory')}
                  className={`flex-1 lg:flex-none inline-flex items-center justify-center px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all ${
          ...
          {activeView === 'inventory' && (
            <div className="mt-3 sm:mt-4 max-w-xl animate-fade-in stagger-2">
          ...
          <>
            <div className="flex items-center justify-between gap-3 mb-2 sm:mb-4">
              <p className="text-slate-300 text-xs sm:text-sm">
                Showing <span className="text-white font-semibold">{filteredVehicles.length}</span>{' '}
                result{filteredVehicles.length === 1 ? '' : 's'}
              </p>
              <button
                type="button"
                onClick={() => {
            ...
            {loading ? (
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-10 text-center">
                <p className="text-gray-300 text-lg font-semibold mb-1">No matches found</p>
